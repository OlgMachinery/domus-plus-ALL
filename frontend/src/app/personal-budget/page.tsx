...
import PersonalBudgetClient from "./PersonalBudgetClient";

export const dynamic = "force-dynamic";

export default async function PersonalBudgetPage(props: { searchParams?: Promise<{ year?: string }> }) {
